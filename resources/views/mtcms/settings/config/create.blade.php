...
@section('title') {{trans('app.new_definition')}} - {{trans('app.definitions')}} @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li><a href="{{URL::to('settings/config/create')}}">{{trans('app.new_definition')}}</a></li>
            </ul>
        </div>
    </div>
    <!-- BEGIN PAGE CONTENT-->
    ...
    <div class="portlet">
        <div class="portlet-title">
            <div class="caption"><i class="fa fa-users"></i> {{trans('app.new_definition')}}</div>
        </div>
